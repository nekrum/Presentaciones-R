...
Este documento pretende ser una demostración de las capacidades **básicas** de una presentación desarrollada en **Slidy**.
No pretende determinar ni la mejor ni la peor librería,  solo conocer sus capacidades. Por lo tanto intentare probar
diferentes estructuras y ver el resultado final de las mismas.
...
Slidy presenta las mismas características que **Ioslides** y permite los gráficos interactivos sin problema alguno.
Ademas el tamaño de la presentación final es pequeño en comparación con el **html** de **Ioslides**. 
